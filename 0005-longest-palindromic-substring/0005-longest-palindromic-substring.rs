...
mod tests {
    ...
    #[test]
    fn find_longest() {
        assert_eq!("aba".to_string(), Solution::longest_palindrome("aba".to_string()));
        assert_eq!("abba".to_string(), Solution::longest_palindrome("abba".to_string()));
        ...
        assert_eq!("aca".to_string(), Solution::longest_palindrome("aacabdkacaa".to_string()));
    }
}